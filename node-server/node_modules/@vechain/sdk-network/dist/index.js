...
var AccountsModule = class {
  ...
  async getStorageAt(address, position, options) {
    ...
    (0, import_sdk_errors7.assert)(
      "getStorageAt",
      import_sdk_core2.dataUtils.isHexString(position) && position.length === 66,
...
var _getDelegationSignature = async (tx, delegatorUrl, originAddress, httpClient) => {
  const rawTx = import_sdk_core3.Hex.of0x(tx.encoded);
...
var TransactionsModule = class {
  ...
  async sendRawTransaction(raw) {
    (0, import_sdk_errors11.assert)(
      "sendRawTransaction",
      import_sdk_core5.dataUtils.isHexString(raw),
  ...
  async buildTransactionBody(clauses, gas, options) {
    ...
    const constTxBody = {
      nonce: `0x${import_sdk_core5.dataUtils.toHexString((0, import_crypto.randomBytes)(8))}`,
...
var Contract = class {
      ...
      get: (_target, prop) => {
        return async (...args) => {
          return await this.thor.contracts.executeContractCall(
            ...
            args,
            {
              caller: this.callerPrivateKey !== void 0 ? import_sdk_core7.addressUtils.fromPrivateKey(
                Buffer.from(
  ...
  getFunctionFragment(prop) {
    const functionFragment = import_sdk_core7.coder.createInterface(this.abi).getFunction(prop.toString());
    if (functionFragment == null) {
      throw (0, import_sdk_errors13.buildError)(
        "Contract.getFunctionFragment",
        import_sdk_errors13.ERROR_CODES.ABI.INVALID_FUNCTION,
...
var ContractFactory = class {
  ...
  async startDeployment(deployParams, options) {
    const deployContractClause = import_sdk_core8.clauseBuilder.deployContract(
      this.bytecode,
      deployParams
    );
    const gasResult = await this.thor.gas.estimateGas(
      [deployContractClause],
      import_sdk_core8.addressUtils.fromPrivateKey(Buffer.from(this.privateKey, "hex"))
    );
...
var ContractsModule = class {
  ...
  async executeContractCall(contractAddress, functionFragment, functionData, contractCallOptions) {
      ...
      [
        {
          to: contractAddress,
          value: "0",
          data: new import_sdk_core9.abi.Function(functionFragment).encodeInput(
            functionData
          )
        }
      ],
    ...
    return new import_sdk_core9.abi.Function(functionFragment).decodeOutput(
      response[0].data
    );
  }
  /**
  ...
  async executeContractTransaction(privateKey, contractAddress, functionFragment, functionData, options) {
    const clause = import_sdk_core9.clauseBuilder.functionInteraction(
      contractAddress,
      functionFragment,
      functionData
    );
    const gasResult = await this.thor.gas.estimateGas(
      [clause],
      import_sdk_core9.addressUtils.fromPrivateKey(Buffer.from(privateKey, "hex"))
    );
    const txBody = await this.thor.transactions.buildTransactionBody(
      [clause],
      gasResult.totalGas,
  ...
  async getBaseGasPrice() {
    return await this.executeContractCall(
      import_sdk_core9.PARAMS_ADDRESS,
      import_sdk_core9.coder.createInterface(import_sdk_core9.PARAMS_ABI).getFunction("get"),
      [import_sdk_core9.dataUtils.encodeBytes32String("base-gas-price")]
    );
  }
};
...
var SOLIDITY_ERROR_SELECTOR = (0, import_sdk_core10.keccak256)("Error(string)", "hex").slice(0, 10);
var SOLIDITY_PANIC_SELECTOR = (0, import_sdk_core10.keccak256)("Panic(uint256)", "hex").slice(0, 10);
...
var GasModule = class {
  ...
  async estimateGas(clauses, caller, options) {
    ...
    const intrinsicGas = import_sdk_core12.TransactionUtils.intrinsicGas(clauses);
...
var DebugModule = class {
  ...
  async traceContractCall(input, name) {
    if (input.contractInput?.to !== void 0 && input.contractInput.to !== null) {
      (0, import_sdk_errors16.assert)(
        "traceContractCall",
        import_sdk_core13.addressUtils.isAddress(input.contractInput.to),
    ...
    if (input.contractInput?.data !== void 0)
      (0, import_sdk_errors16.assert)(
        "traceContractCall",
        import_sdk_core13.dataUtils.isHexString(input.contractInput.data, true),
        import_sdk_errors16.DATA.INVALID_DATA_TYPE,
    ...
    if (input.contractInput?.value !== void 0)
      (0, import_sdk_errors16.assert)(
        "traceContractCall",
        import_sdk_core13.dataUtils.isHexString(input.contractInput.value, true),
        import_sdk_errors16.DATA.INVALID_DATA_TYPE,
  ...
  validateTarget(target, functionName) {
    (0, import_sdk_errors16.assert)(
      "validateTarget",
      import_sdk_core13.dataUtils.isThorId(target.blockID, true),
      import_sdk_errors16.DATA.INVALID_DATA_TYPE,
    ...
    if (typeof target.transaction === "string")
      (0, import_sdk_errors16.assert)(
        "validateTarget",
        import_sdk_core13.dataUtils.isThorId(target.transaction, true),
        import_sdk_errors16.DATA.INVALID_DATA_TYPE,
